...
def parse_args(args):
    ...
    parser.add_argument("--aff_seg_data", default="handal||openx||egoobjects", type=str)
    parser.add_argument("--aff_sample_rates", default="1,1,1", type=str)
    parser.add_argument("--reason_aff_data", default="handal_no_objects||egoobjects_with_objects||egoobjects_no_objects", type=str)
    parser.add_argument("--reason_aff_sample_rates", default="1,1,1", type=str)
